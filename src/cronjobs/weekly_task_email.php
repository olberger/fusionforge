 ...
 *
 * @version   $Id: daily_task_email.php 5426 2006-04-28 11:47:17Z danper $
 *
...
require_once $gfommon.'pm/ProjectTasksForUser.class.php';
...
for ($i=0; $i<db_numrows($res);$i++) {
	...
	if (!$user_object || !is_object($user_object)) {
		...
		$userTasks =& $projectTasksForUser->getTasksForThisWeek();

		// start composing the email	
		$subject = 'Tasks for '.$realname.' for week '.date('W');
