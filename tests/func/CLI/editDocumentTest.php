...
class EditDocument extends FForge_SeleniumTestCase
{
	function testEditDocument()
	{
		...
		$ret = $this->CLI("document updatedocument --doc_group=1 --doc_id=1 --title=\"Document name\" --description=\"New description\" --language_id=1 --filename=$file --state_id=1");
		$this->assertEquals($ret, 0);
		$expected = "+--------+\n| Result |\n+--------+\n| 1      |\n+--------+";
		$this->assertEquals($expected, $this->getOutput());
	}
