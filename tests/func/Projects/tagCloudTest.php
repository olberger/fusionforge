...
class TagCloud extends FForge_SeleniumTestCase
{
  function testTagCloud()
  {
    ...
    $this->type("form_tags", "software, green touch, accessibilty");
    $this->clickAndWait("submit");
    $this->assertTextPresent("Project information updated");
    $this->clickAndWait("link=Project Summary");
    $this->assertTextPresent("Tags: software, green touch, accessibilty");
    $this->clickAndWait("link=green touch");
