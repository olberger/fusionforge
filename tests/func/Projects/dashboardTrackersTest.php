...
class DashboardTrackers extends FForge_SeleniumTestCase
{
  function testDashboardTrackers()
  {
    ...
    for ($i=1; $i<=10; $i++) {
        ...
        $this->type("summary", "Bug number $i");
        $this->type("details", "Details about bug number $i");
        $this->clickAndWait("submit");
        $this->assertTextPresent("regexp:Item \[#[0-9]+\] successfully created");
    }
    $this->clickAndWait("link=Project Summary");
    $this->clickAndWait("link=Statistics");
    $this->clickAndWait("submit");
    // Graphics is not displayed :-(
