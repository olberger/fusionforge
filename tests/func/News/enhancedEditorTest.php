...
class EnhancedEditor extends FForge_SeleniumTestCase
{
	function testEnhancedEditor()
	{
		$this->init();
		$this->logout();
		...
		$this->assertTextPresent("No News Items Found");

		// Cannot use fckeditor with Selenium
	}
}
?>
