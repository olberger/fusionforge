...
class ListReleasesJava extends FForge_SeleniumTestCase
{
	function testListReleasesJava()
	{
		$this->init();
		...
		for ($i=1; $i<=10; $i++) {
			...
			$this->type("release_name", "Version $i.0");
		...
		$id =$this->Jagosi("FRS.sh -u admin -p myadmin -g projecta -d ", " | grep 'Version' | awk '{print $2}'");
